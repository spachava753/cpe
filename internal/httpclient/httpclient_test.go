...
func TestNewPreservesBaseClientAndAppliesDefaultTimeout(t *testing.T) {
	...
	client := New(
		func(o *options) { o.baseClient = base },
		func(o *options) { o.defaultTimeout = &defaultTimeout },
	)
	if client == base {
...
func TestTransport(t *testing.T) {
	t.Run("with retry statuses false", func(t *testing.T) {
		t.Run("does not retry http status", func(t *testing.T) {
			attempts := 0
	...
	t.Run("retries and closes intermediate response body", func(t *testing.T) {
		attempts := 0
