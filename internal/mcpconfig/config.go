...
// When Type is empty, stdio is assumed. Validation tags enforce basic transport
// constraints, with additional cross-field checks performed in internal/config.
type ServerConfig struct {
	Command       string            `json:"command" yaml:"command"`
	Args          []string          `json:"args" yaml:"args"`
	Type          string            `json:"type,omitempty" yaml:"type,omitempty" validate:"omitempty,oneof=stdio sse http" jsonschema:"enum=stdio,enum=sse,enum=http"`
