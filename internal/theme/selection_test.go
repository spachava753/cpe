...
func TestSelectCreatesConfigAndPersistsBuiltins(t *testing.T) {
...
func TestSelectPreservesCustomDefinitionsAndSymlink(t *testing.T) {
	dir := t.TempDir()
...
func TestFailedSelectionDoesNotModifyConfig(t *testing.T) {
	dir := t.TempDir()
	path := filepath.Join(dir, "themes.json")
