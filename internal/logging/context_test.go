...
func TestContextHandler(t *testing.T) {
	t.Run("evaluates enabled on scoped handler", func(t *testing.T) {
	...
	t.Run("adds scoped attributes", func(t *testing.T) {
	...
	t.Run("keeps scoped attributes at root under groups", func(t *testing.T) {
		var output bytes.Buffer
	...
	t.Run("does not reuse delegated attr slices", func(t *testing.T) {
		var output bytes.Buffer
	...
	t.Run("resolves logger attrs once", func(t *testing.T) {
		var output bytes.Buffer
		calls := 0
