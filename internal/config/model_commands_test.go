...
func TestInfoCommand(t *testing.T) {
	t.Run("prints cache pricing fields", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("prints vertex fields", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("prints thinking values", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("prints na when pricing unavailable", func(t *testing.T) {
		t.Parallel()
