...
Resolution precedence:
  ...
  - tool-oriented features such as codeMode, flightRecorder, and compaction use
    whole-object model overrides instead of field-level merging.

The package also validates custom invariants (model references, auth method
constraints, subagent/output schema checks, codeMode path normalization,
