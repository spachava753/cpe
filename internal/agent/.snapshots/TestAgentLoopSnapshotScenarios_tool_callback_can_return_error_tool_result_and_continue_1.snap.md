...
| "msg_003" | "msg_002" | NULL                 | "tool_result" | true              | NULL                 | NULL      | NULL     | NULL       | NULL               | NULL         | NULL          | NULL              | NULL               |
| "msg_004" | "msg_003" | NULL                 | "assistant"   | false             | NULL                 | NULL      | NULL     | NULL       | NULL               | 74           | 25            | NULL              | NULL               |

### blocks

| id       | message_id | block_type  | modality_type | mime_type    | content                                    | extra_fields | sequence_order |
|:---------|:-----------|:------------|:--------------|:-------------|:-------------------------------------------|:-------------|:---------------|
| NULL     | "msg_001"  | "content"   | 0             | "text/plain" | "use fragile tool"                         | NULL         | 0              |
| "call_1" | "msg_002"  | "tool_call" | 0             | "text/plain" | "{\"name\":\"fragile\",\"parameters\":{}}" | NULL         | 0              |
| "call_1" | "msg_003"  | "content"   | 0             | "text/plain" | "recoverable tool failure"                 | NULL         | 0              |
| NULL     | "msg_004"  | "content"   | 0             | "text/plain" | "recovered from tool error"                | NULL         | 0              |
