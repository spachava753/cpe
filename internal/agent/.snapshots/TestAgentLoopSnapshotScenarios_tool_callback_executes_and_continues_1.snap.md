...
```> message_id: `msg_002`> input: `10`, output: `43`

#### Tool "lookup" result:

```
lookup result
```> message_id: `msg_003`> message_id: `msg_004`> input: `66`, output: `12`
````
...
| "msg_002" | "msg_001" | NULL                 | "assistant"   | false             | NULL                 | NULL      | NULL     | NULL       | NULL               | 10           | 43            | NULL              | NULL               |
| "msg_003" | "msg_002" | NULL                 | "tool_result" | false             | NULL                 | NULL      | NULL     | NULL       | NULL               | NULL         | NULL          | NULL              | NULL               |
| "msg_004" | "msg_003" | NULL                 | "assistant"   | false             | NULL                 | NULL      | NULL     | NULL       | NULL               | 66           | 12            | NULL              | NULL               |
