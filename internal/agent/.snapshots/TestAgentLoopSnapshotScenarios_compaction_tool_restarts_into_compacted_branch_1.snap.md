...
```> message_id: `msg_002`> message_id: `msg_004`
````
...
|:---------|:-----------|:------------|:--------------|:-------------|:---------------------------------------------------------------------------------|:-------------|:---------------|
| NULL     | "msg_001"  | "content"   | 0             | "text/plain" | "start before compact"                                                           | NULL         | 0              |
| "call_1" | "msg_002"  | "tool_call" | 0             | "text/plain" | "{\"name\":\"compact_conversation\",\"parameters\":{\"summary\":\"condensed\"}}" | NULL         | 0              |
| NULL     | "msg_003"  | "content"   | 0             | "text/plain" | "summary=condensed parent=msg_002 tool=compact_conversation"                     | NULL         | 0              |
| NULL     | "msg_004"  | "content"   | 0             | "text/plain" | "after compact"                                                                  | NULL         | 0              |
