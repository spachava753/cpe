...
func TestPhaseRetryGeneratorForResponses(t *testing.T) {
	t.Run("generate", func(t *testing.T) {
		...
		for _, tt := range tests {
			t.Run(tt.name, func(t *testing.T) {
				...
				resp, err := gen.Generate(ctx, gai.Dialog{{
					Role:   gai.User,
	...
	t.Run("register delegates", func(t *testing.T) {
		inner := &scriptedPhaseRetryGenerator{}
		gen := &responsesPhaseRetryGenerator{GeneratorWrapper: gai.GeneratorWrapper{Inner: inner}}
