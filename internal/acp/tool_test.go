...
func TestStarlarkREPLCallback(t *testing.T) {
	t.Run("supports open and bytes decode", func(t *testing.T) {
		t.Parallel()
...
print(data.decode("utf-8"))`,
	...
	t.Run("allows http requests", func(t *testing.T) {
		t.Parallel()
...
print(response.text)`, server.URL+"/status"),
	...
	t.Run("reset closes open files", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("persists state and reset starts fresh sphere", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("repeated successful calls remain uncancelled", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("runs host subprocess in session directory", func(t *testing.T) {
		t.Parallel()
...
print(result.stdout.strip())`,
	...
	t.Run("cancels host subprocess at execution timeout", func(t *testing.T) {
		t.Parallel()
...
subprocess.run(["sleep", "10"])`,
	...
	t.Run("returns only printed text", func(t *testing.T) {
		t.Parallel()
...
print("right", end="")`,
	...
	t.Run("persists functions and mutable values", func(t *testing.T) {
		t.Parallel()
...
def add_item(item):
	...
	t.Run("cancels thread at execution timeout", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("rejects already canceled context", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("cancellation returns partial output", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("cancels thread with parent context", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("returns execution errors with output", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("returns errors from every terminal session update", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("reports execution statuses", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("reports multimodal result in one completed update", func(t *testing.T) {
		t.Parallel()
...
view_file("video.mp4", mime_type="video/mp4")`,
	...
	t.Run("loads dyson modules and globals", func(t *testing.T) {
		t.Parallel()
...
print(json.dumps({"b": [2], "a": True}))`,
	...
	t.Run("view file errors", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("truncates print output", func(t *testing.T) {
		t.Parallel()
