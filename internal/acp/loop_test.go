...
func TestLoop(t *testing.T) {
	t.Run("block provenance survives storage restart", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("persists tool result when prompt is cancelled during callback", func(t *testing.T) {
		t.Parallel()
		...
		dialog, err := loop.Generate(
			context.WithValue(ctx, sessionIDCtxKey{}, acp.SessionId("test-session")),
	...
	t.Run("tool callback receives persisted assistant message id", func(t *testing.T) {
		t.Parallel()
		...
		if _, err := loop.Generate(
			context.WithValue(t.Context(), sessionIDCtxKey{}, acp.SessionId("test-session")),
	...
	t.Run("usage session update", func(t *testing.T) {
		tests := []struct {
			name     string
			model    config.Model
	...
	t.Run("usage session update cost accumulates across loops", func(t *testing.T) {
		store, _ := newTestSqlite(t)
	...
	t.Run("effective gen opts", func(t *testing.T) {
		tests := []struct {
			name        string
			modelType   string
	...
	t.Run("effective gen opts does not mutate input extra args", func(t *testing.T) {
	...
	t.Run("generate commits compaction before publishing completion", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("generate panics when compaction root persistence fails", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("compaction rejects invalid arguments", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("compaction retry limit", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("compaction creates tool error for template failure", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("compaction clears starlark repl state", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("compaction plans successful rebase without resetting state", func(t *testing.T) {
		t.Parallel()
