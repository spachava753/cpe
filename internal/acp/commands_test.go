...
func TestListStoredSessions(t *testing.T) {
	t.Run("pagination and formatting", func(t *testing.T) {
	...
	t.Run("rejects unsafe pagination", func(t *testing.T) {
...
func TestFork(t *testing.T) {
	t.Run("stored session of old history is listed as new", func(t *testing.T) {
		store, rawDB := newTestSqlite(t)
	...
	t.Run("and delete stored session preserve shared history", func(t *testing.T) {
		store, _ := newTestSqlite(t)
