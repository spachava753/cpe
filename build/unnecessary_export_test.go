...
func TestFindUnnecessaryExportsIgnoresDeclarationsUsedByAnotherPackage(t *testing.T) {
	t.Parallel()
...
func TestFindUnnecessaryExportsReportsImportCollisionWithoutFix(t *testing.T) {
	t.Parallel()
...
func TestFindUnnecessaryExportsReportsRenameCollisionWithoutFix(t *testing.T) {
	t.Parallel()
